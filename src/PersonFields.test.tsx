...
import PersonFields from "./PersonFields.tsx";
import { getTextFieldWithLabel } from "./TestUtils.ts";

describe("PersonFields", () => {
  it("renders", () => {
    render(<PersonFields aria-label="FOO" />);
  ...
  describe("First name", () => {
    it("displays if provided", () => {
      render(<PersonFields aria-label="FOO" firstName="FIRST_NAME" />);
  ...
  describe("Last name", () => {
    it("displays if provided", () => {
      render(<PersonFields aria-label="FOO" lastName="LAST_NAME" />);
  ...
  describe("didChangeValue", () => {
    ...
    describe("firstName", () => {
      it("is called when value changes", async () => {
        ...
        render(<PersonFields aria-label="FOO" didChangeValue={callback} />);
